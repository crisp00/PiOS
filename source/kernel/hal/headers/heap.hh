...
namespace heap{
    ...
    #define HEAP_BITMAP_LENGTH 1048576
    #define HEAP_BITMAP_ARRAY_SIZE 131072
    #define HEAP_BITMAP_USED true
    #define HEAP_BITMAP_FREE false


    #define HEAP_BLOCK_HEADER_MAGIC 0x2b4a
    #define HEAP_BLOCK_HEADER_LENGTH sizeof 19
    #define HEAP_BLOCK_MAP_LENGTH 453
    #define HEAP_BLOCK_SPACE_LENGTH 3624

    #define HEAP_BLOCK_NO_SPACE 0xf000

    struct __attribute__((packed)) pmm_block_map{
        uint8_t map[HEAP_BLOCK_MAP_LENGTH];
    }typedef block_map_t;
    ...
    */
    ...
    struct __attribute__((packed)) pmm_block{
        ...
        block_map_t map;
        uint8_t space[HEAP_BLOCK_SPACE_LENGTH];
    };
